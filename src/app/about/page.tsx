...
export default function AboutPage() {
  return (
    <div className="min-h-screen pt-36 pb-20 px-6 flex flex-col items-center justify-center bg-void text-white">
      <h1 className="font-heading text-4xl md:text-6xl mb-6 tracking-wider">ABOUT DRAGON GROUP LK</h1>
      <div className="max-w-2xl text-center text-white/70 space-y-4">
        <p>
          Dragon Group LK is an independent streetwear label born from the underground scenes of Sri Lanka.
          We blend premium materials with local street culture to create timeless, limited-run pieces.
        </p>
        <p>
