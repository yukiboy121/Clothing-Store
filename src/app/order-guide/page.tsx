    ...
    <div className="min-h-screen pt-36 pb-24 bg-void text-white">
      <div className="max-w-4xl mx-auto px-6 lg:px-12">
        ...
        <div className="space-y-6 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-white/10 before:to-transparent">
          {steps.map((step, index) => (
            <div key={index} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
              <div className="flex items-center justify-center w-10 h-10 rounded-full border-4 border-void bg-abyss text-white font-bold text-xs shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 z-10">
                {step.number}
              </div>
              
              <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-abyss border border-white/5 p-6 rounded-xl hover:border-white/30 transition-colors">
        ...
        <div className="mt-20 text-center">
          <Link 
            href="/shop"
            className="inline-flex items-center justify-center px-10 py-4 bg-white text-black font-bold uppercase tracking-[0.2em] text-sm hover:bg-white/80 transition-colors"
          >
            Start Shopping Now
          </Link>
        </div>
