...
export function LatestGearSection({ products }: { products: Product[] }) {
  ...
  return (
    <section className="py-20 md:py-32 px-6 md:px-10 max-w-[1800px] mx-auto">
      ...
      >
        <div>
          <h2 className="font-heading text-4xl md:text-6xl lg:text-7xl tracking-wider">LATEST GEAR</h2>
          <p className="text-white/40 text-sm mt-3 tracking-wider">Fresh styles and new arrivals.</p>
        </div>
        <Link
          href="/shop"
